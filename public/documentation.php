...
$queryProducts = "SELECT products.* 
FROM products  
LIMIT 2";

$stmt = $database->prepare($queryProducts);
$stmt->execute();
$resultProducts = $stmt->fetchAll();

$queryReviews = "SELECT reviews.* 
FROM reviews  
LIMIT 2";

$stmt = $database->prepare($queryReviews);
$stmt->execute();
$resultReviews = $stmt->fetchAll();
...
<body>
    <div class="container">
        <h1 class="mb-3">Documentation pour l'ECF :o </h1>

        <h6>Vous devrez appeler cette URL, avec les endpoints décrits ici : http://localhost:8080</h6>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        <div class="btn btn-small btn-primary d-inline-block" style="margin-right:25px;">GET</div>
                        <span>/products.php</span>
                    </button>
                </h2>
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        Permet de récuperer un tableau de produits disponibles au café. <br>
                        <h4>Résultat : </h4>
                        <pre>
                            <?php
                    ...
                    <div class="accordion-body">
                        ...
                        <pre>
                            ...
                            print_r(array(
                                ...
                                "company" => "Ma boite de dev' (Peut être NULL)",
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                        <div class="btn btn-small btn-primary d-inline-block" style="margin-right:25px;">GET</div>
                        <span>/reviews.php (BONUS)</span>
                    </button>
                </h2>
                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        Permet de récuperer un tableau d'avis laissés par les clients du café. <br>
                        <h4>Résultat : </h4>
                        <pre>
                            <?php
